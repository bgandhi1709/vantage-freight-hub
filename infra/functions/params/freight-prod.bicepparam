...
param storageAccountName = readEnvironmentVariable('STORAGE_ACCOUNT_NAME', 'vwfreightprodsa')
param appServicePlanName = readEnvironmentVariable('APP_SERVICE_PLAN_NAME', 'vw-shared-prod-plan')
param forwarderBaseUrl = readEnvironmentVariable('FORWARDER_BASE_URL', 'https://forwarder-prod.example.test/v1')
